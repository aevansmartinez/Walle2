...
namespace testing2.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            detailsVM.Sentiment = avgResult.ToString();
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IMDBLink,Gender,Age,Photo")] Actor actor, IFormFile Photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IMDBLink,Gender,Age,Photo")] Actor actor, IFormFile Photo)
        {
            if (id != actor.Id)
            {
                return NotFound();
